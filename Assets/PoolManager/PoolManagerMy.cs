...
//using System.Diagnostics;
    ...
    /// </description>
    public static class PoolManagerMy
    {
    ...
    public class SpawnPoolsDict : IDictionary<string, SpawnPool>
    {
        ...
        internal void Add(SpawnPool spawnPool)
        {
			...
			if (this.onCreatedDelegates.ContainsKey(spawnPool.poolName))
            {
                ...
                this.RemoveOnCreatedDelegate(spawnPool.poolName, this.onCreatedDelegates[spawnPool.poolName]); // remove delegate after execution to prevent duplicates
            }
        }
